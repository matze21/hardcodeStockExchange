...
data = beyond_meat['<CLOSE>']#[20000:21028]
data = data.to_numpy()


tic = time.time()
moneyMade, appendActions, portfolioValue, madeMoneyPercentage, efficiency = differenceBasedApproach.simulateAlgo(data, 12, 2, 5)  #10 long term, 3 short term, 10% sell threshold
toc = time.time()
